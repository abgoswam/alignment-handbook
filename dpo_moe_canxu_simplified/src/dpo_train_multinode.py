...
def train():
    ...
    #model_refer = model_refer.to(local_rank)


    #model_refer.is_parallelizable = True
    #model_refer.model_parallel = True
    ...
    if list(pathlib.Path(training_args.output_dir).glob("tmp-checkpoint-*")):
